...
class Address{ 
    constructor(page){ 
        ...
        this.selectAddressOption=page.locator("ul.list li");
        this.addAddress=page.locator(".add-button")
    ...
    async FillTheAddress(fname,lname,email,company,country,state,city,address,zip,phone){ 
